...
class LogisticRegressor:
    ...
    def predict(self, X, threshold=0.5):
        ...
        classification_result =  np.array([1 if p > threshold else 0 for p in probabilities])
    ...
    def lasso_regularization(self, dw, m, C):
        ...
        lasso_gradient = np.sign(self.weights)
        return dw + (C / m) * lasso_gradient
    ...
    def ridge_regularization(self, dw, m, C):
        ...
        ridge_gradient = self.weights
        
        return dw + (C / m) * ridge_gradient
    ...
    def elasticnet_regularization(self, dw, m, C, l1_ratio):
        ...
        lasso_gradient = np.sign(self.weights)
        ridge_gradient = self.weights
        return dw + (C / m) * (l1_ratio * lasso_gradient + (1 - l1_ratio) * ridge_gradient)
